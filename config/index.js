export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxb578dd880c978402",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "6c54519cb8872759e549b7d90f1349ab",
   ...
   */
  USERS: [oVlEv5rSw9icf5TVjMo4mby8F3VA
    {
      // 想要发送的人的名字
      name: "宝贝0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "	Qvjbk8gzEEbjhRBZCKMQ1xp2p6H9QCCKDgw2-Fg7aBA",
      // 所在省份
      province: "四川",
      // 所在城市
      city: "宜宾",
      ...
      festivals: [
        ...
        {"type": "节日", "name": "结婚纪念日", "year": "2025", "date": "10-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "宝贝", "year": "2003", "date": "07-08"},
        {"type": "节日", "name": "周年纪念日", "year": "2021", "date": "10-21"},
      ],
